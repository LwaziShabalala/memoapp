    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        <div className="flex justify-between items-center mb-4">
          ...
          <button onClick={closePayPalModal} className="text-gray-500 hover:text-gray-700">
        ...
        <div className="relative bg-gray-900 text-white rounded-xl shadow-lg p-8 space-y-8 min-h-[400px]">
          ...
          <div className="space-y-4 text-base text-gray-300">
            ...
            {sendUp && title !== "1 Year Access" && (
              <p className="leading-relaxed">Exclusive features and priority updates coming soon!</p>
            )}
          </div>
