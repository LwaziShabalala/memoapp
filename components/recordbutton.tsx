    ...
    return (
        <div className="flex flex-col items-center">
            <Card
                ...
                className={`p-6 border-black/5 flex flex-col items-center justify-center transition w-40 h-40 ${isProcessing ? 'cursor-not-allowed opacity-80' : 'hover:shadow-md cursor-pointer'
                    }`}
            >
